...
const DetailsBanner = ({ video, crew }: Props) => {
  ...
  const PosterFallback = 'https://github.com/ShariqAnsari88/movix/blob/main/src/assets/no-poster.png?raw=true'
            ...
            <>
              ...
              <div className="flex relative flex-col md:flex-row gap-[25px]">
                ...
                <div className="shrink-0">
                  {data.poster_path ? (
                    <Img className="w-96 block rounded-xl" src={url.backdrop + data.poster_path} />
                  ) : (
                    <Img className="w-full block rounded-xl" src={PosterFallback} />
                  )}
                </div>
                {/* right */}
                <div className="text-white">
                  ...
                  <div className="text-[16px] leading-[24px] mb-[15px] opacity-[0.5] italic">{data.tagline}</div>
                  ...
                  <div className="flex items-center gap-[25px] w-full mb-[25px]">
                    ...
                    >
                      <BsPlay className="flex items-center  cursor-pointer" size={'55px'} />
                      <span className="text-basemd:text-2xl">Watch Trailer</span>
                    </div>
                  </div>
                  ...
                  <div className="border-b-2 border-white/10 p-[15px] flex">
                    ...
                    {data.release_date && (
                      <div>
                        <span className="mr-[10px]  leading-[24px] font-bold">Release Date: </span>
                    ...
                    {data.runtime && (
                      <div>
                        <span className="mr-[10px] leading-[24px] font-bold">Runtime: </span>
                        <span className="mr-[10px] opacity-[0.5] leading-[24px]">{toHoursAndMinutes(data.runtime)}</span>
                      </div>
                    )}
                  </div>
                  ...
                  {data?.created_by?.length > 0 && (
                    <div>
                      <span className="mr-[10px] leading-[24px] font-bold">Creator: </span>
                      <span className="mr-[10px] opacity-[0.5] leading-[24px]">
